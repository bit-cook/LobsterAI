...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    emailTab: '邮箱',
    emailConfig: '邮箱配置',
    emailAccountsHint: '管理 Agent 可使用的 IMAP/SMTP 邮箱账号。旧版单邮箱配置会自动作为默认账号读取。',
    emailAccount: '邮箱账号',
  ...
  en: {
    ...
    emailAccountsHint: 'Manage IMAP/SMTP email accounts available to agents. Legacy single-account settings are read as the default account.',
