...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    openClawDataBackupDesc: '备份任务记录、自定义模型配置、skill、记忆等数据。',
    openClawDataMigrationTitle: '数据迁移',
    openClawDataMigrationDesc: '将数据备份的结果迁移到当前应用。',
  ...
  en: {
    ...
    openClawDataBackupDesc: 'Back up task records, custom model configurations, skills, memory, and related data.',
    openClawDataMigrationTitle: 'Data Migration',
    openClawDataMigrationDesc: 'Migrate a data backup into the current app.',
