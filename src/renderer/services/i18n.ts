...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    themeColor: '主题色',
    aiSkin: 'AI 皮肤',
    aiSkinDescription: '应用 AI 皮肤时会自动匹配推荐的深浅色主题；停用或删除后不会自动切回此前主题。',
    aiSkinActive: '当前皮肤',
    aiSkinNone: '当前未应用自定义皮肤',
    aiSkinLibrary: '已生成皮肤',
    aiSkinPreviewHint: '这里展示实际背景预览；应用后会同步显示在会话首页和会话背景中。',
    aiSkinCreationGuide: '需要创作新皮肤时，可前往“专家套件”找到「LobsterAI 外观定制」，也可直接使用这里的快捷入口。',
  ...
  en: {
    ...
    aiSkin: 'AI skin',
    aiSkinDescription: 'Applying an AI skin automatically selects its recommended light or dark theme. Disabling or deleting it does not switch back.',
    ...
    aiSkinCreationGuide: 'To create a new skin, find “Customize LobsterAI” in Expert Kits or use this shortcut.',
    ...
    aiSkinDeleteActiveWarning: 'This skin is in use. Deleting it removes the AI skin and keeps the current color theme.',
