...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkAddFile: '添加文件',
    voiceInput: '点击开始听写',
    voiceInputStopRecording: '点击结束听写',
    ...
    voiceInputQuotaExhausted: '暂无听写时长',
    voiceInputQuotaExhaustedTitle: '听写时长已用完',
    voiceInputQuotaExhaustedFreeDesc: '今日 {limit} 听写时长已用完。升级订阅可获得每日 200 分钟听写时长。',
    voiceInputQuotaExhaustedSubscribedDesc: '今日 {limit} 听写时长已用完。',
  ...
  en: {
    ...
    voiceInput: 'Click to start dictation',
    voiceInputStopRecording: 'Click to end dictation',
    ...
    voiceInputQuotaExhausted: 'No dictation time available',
    voiceInputQuotaExhaustedTitle: 'Dictation time used up',
    voiceInputQuotaExhaustedFreeDesc: 'Today’s {limit} dictation time has been used up. Upgrade to get 200 minutes per day.',
    voiceInputQuotaExhaustedSubscribedDesc: 'Today’s {limit} dictation time has been used up.',
