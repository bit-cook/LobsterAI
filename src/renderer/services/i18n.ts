...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    nodeDeploymentPersistenceDisabledHint: '未检测到需要保留的本地位置。如果服务会在项目目录中保存运行数据，可以手动添加对应文件夹。',
  ...
  en: {
    ...
    nodeDeploymentPersistenceDisabledHint: 'No local data location was detected. Add a folder if this service saves runtime data inside the project.',
